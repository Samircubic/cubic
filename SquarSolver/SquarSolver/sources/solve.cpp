...
void solve (equation_parameters_t *data)  ///< вызов функции решающей уравнения
{
    assert (data);
...
void program_liner (equation_parameters_t *data)      //линейные
{
    assert (data);
...
void program_squar (equation_parameters_t *data)       //квадратные
{
    assert (data);
